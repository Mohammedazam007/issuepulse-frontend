...
import { Zap, User, Mail, Lock, ArrowRight, Eye, EyeOff, GraduationCap, Shield } from 'lucide-react'
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md animate-fade-up">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {[
              { name: 'name',  type: 'text',  Icon: User, placeholder: 'Rahul Sharma',       label: 'Full Name' },
              { name: 'email', type: 'email', Icon: Mail, placeholder: 'you@anurag.edu.in',  label: 'Email'     },
            ].map(({ name, type, Icon, placeholder, label }) => (
              <div key={name}>
                ...
                <div className="relative">
                  ...
                  <input name={name} type={type} required placeholder={placeholder}
                    ...
                    className="w-full bg-white/6 border border-white/12 text-white placeholder-slate-600
